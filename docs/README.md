...
| 11 | [assets.md](./assets.md) | 에셋 3계층(절차생성/AI생성/주입필수) + 슬롯 규약 + 요청 매니페스트 | 이미지 슬롯을 다룰 때 |
| 12 | 🔴 **[compliance.md](./compliance.md)** | 표시·광고 법적 하드 게이트 (식약처 고시·공정위 예규 1차 출처). craft보다 상위 | **카피를 확정할 때 (필수)** |
