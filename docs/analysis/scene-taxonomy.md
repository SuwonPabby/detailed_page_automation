...
> 상태: **M2 (Good 6제품 95블록 라벨 완료)** — 글로우샷·파일변환·꿀잠모드·올리빗·밀밭명가·클렌즈.
> M3에서 구스밀·클렌즈 주스·일진와이어 추가 후 전이 패턴 통계 확정 예정.
...
| `review` | 구매후기 (압축 필수 — design-principles F항) | *(Good 6종 미등장 — M3/Bad에서 확인)* |
